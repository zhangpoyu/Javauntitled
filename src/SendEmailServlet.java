...
public class SendEmailServlet  {
    ...
    public String sendEmail(String receptor, String Title, String Content) {
        ...
        props.put("mail.password", "sniylmqqdtvkeaab");  // 此处的密码是腾讯提供的16位STMP口令
    ...
    public static void main(String args[]){
        String receptor = "2381150086@qq.com";
        String Content = "sdfsdfsdf";
        String Title = "交通违章通告";
        if (receptor != "" && Content != "") {
            SendEmailServlet sendEmailServlet =new SendEmailServlet();
            sendEmailServlet.sendEmail(receptor, Title, Content);
            System.out.println("ok");
        } else {
